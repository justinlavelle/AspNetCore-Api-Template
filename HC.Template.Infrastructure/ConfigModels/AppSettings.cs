...
{
    /* 
       When values aren't provided, they get their default values, (e.g. AppSettings.DictionarySettings["SecondKey].IsEnabled == true). 
       Dictionaries, lists and enums are all bound correctly. 
    ...
    */
    ...
    public class AppSettings
    {
        ...
        public Dictionary<string, MyClass> DictionarySettings { get; set; } // Dictionaries must have string keys
